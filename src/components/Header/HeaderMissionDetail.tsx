...
export default function HeaderMissionDetail({name, loading}: HeaderMissionDetailProps) {
    ...
    return (
        <div
            ...
            {!loading ? (<p className="text-sm text-gray-600 dark:text-gray-400">par {name}</p>) : (
