    ...
    return (
        <>
            ...
            <div className="flex flex-col px-4 py-8 my-20">
                ...
                {step === 1 && (
                    <div
                        className="space-y-4 flex-1 flex flex-col justify-center animate-in fade-in slide-in-from-bottom-4 duration-500">
                        <div className="text-center mb-6">
                            <h1 className="text-xl font-black uppercase tracking-tight">Déposer une mission</h1>
                            <p className="text-xs text-gray-400 mt-1">Sélectionnez la méthode qui vous convient le
                                mieux</p>
                        </div>
                        ...
                        >
                            <Hammer size={28}
                                    className={knowProfession === true ? "text-orange-500" : "text-gray-400 dark:text-gray-500"}/>
                            <div>
                                <span className="block font-black uppercase text-base tracking-tight leading-none mb-1">Je sais exactement</span>
                                <span className="text-xs opacity-80 font-medium">Quel métier d'artisanat j'ai besoin de contacter.</span>
                            </div>
                        </button>
                        ...
                        >
                            <HelpCircle size={28}
                                        className={knowProfession === false ? "text-indigo-500" : "text-gray-400 dark:text-gray-500"}/>
                            <div>
                                <span className="block font-black uppercase text-base tracking-tight leading-none mb-1">Je décris mon besoin</span>
                                <span className="text-xs opacity-80 font-medium">L'application m'aidera à trouver le bon corps de métier.</span>
                            </div>
                        </button>
                    </div>
                )}
                    ...
                    <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-500 pb-16">
                        ...
                        <div className="space-y-1">
                            ...
                            <div className="relative">
                                <div
                                    className="absolute inset-y-0 left-4 flex items-center pointer-events-none text-gray-400 dark:text-gray-500">
                                    <MapPin size={18}/>
                                </div>
                                <input
                                    name="location"
                        ...
                        <div className="space-y-2">
                            <label className={labelStyle}>Photos du projet ({formData.images.length})</label>
                            <div className="grid grid-cols-3 gap-3">
                                ...
                                <label
                                    className="aspect-square border-2 border-dashed border-gray-200 dark:border-gray-700/60 rounded-2xl flex flex-col items-center justify-center cursor-pointer bg-slate-50 dark:bg-neutral-800/30 hover:bg-gray-100 dark:hover:bg-neutral-800/60 transition-colors">
                                    <input type="file" hidden multiple onChange={handleImagesChange} accept="image/*"/>
                                    <Camera size={22} className="text-gray-400 dark:text-gray-500"/>
                                </label>
                            </div>
                        </div>
