        ...
        <div>
          <div className="flex flex-col gap-12">
            <div className="flex flex-col gap-3">
              ...
              <div className="rounded-3xl shadow-sm border overflow-hidden border-gray-100 dark:border-gray-800">
            ...
            <div className="flex flex-col gap-3">
              ...
              <div className="rounded-3xl shadow-sm border border-gray-100 dark:border-gray-800 overflow-hidden">
                <button className="w-full flex items-center justify-between p-4 hover:bg-gray-50 dark:hover:bg-gray-800/40 transition-colors">
                  <div className="flex items-center gap-3">
