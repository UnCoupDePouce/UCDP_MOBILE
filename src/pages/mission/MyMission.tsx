      ...
      <main className="flex-1 overflow-y-auto px-6 pt-12 pb-32">
        ...
        <div className="flex flex-col gap-4">
          <MissionItem
            ...
            onClick={() =>
              setSelectedMission(selectedMission === "1" ? null : "1")
            }
          />
          ...
          <MissionItem
            ...
            onClick={() =>
              setSelectedMission(selectedMission === "2" ? null : "2")
            }
          />
        </div>
      </main>
  ...
  return (
    ...
    >
      <div className="flex justify-between items-start mb-4">
        ...
        <span
          className={`text-[10px] font-black uppercase tracking-widest ${isActive ? "text-white/40 dark:text-black/40" : "text-gray-300 dark:text-neutral-600"}`}
        >
          {date}
        </span>
      </div>
    ...
    <div className="bg-white dark:bg-neutral-900 border border-gray-100 dark:border-white/5 p-4 rounded-[30px] shadow-sm flex flex-col gap-4">
      <div className="flex items-center gap-4">
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-[9px] font-black text-gray-400 dark:text-neutral-500 uppercase tracking-widest mb-2">
            {pro.job}
          </p>
          <span className="text-[11px] font-black text-black dark:text-white italic">
            Proposition : {pro.price}
          </span>
        </div>
      </div>
