        ...
        <>
            <div className="flex flex-col gap-10 px-4 py-8">
                ...
                {step === 2 && (
                    <div className="flex justify-center items-center w-full">
                        <div className="w-16 h-16 flex items-center justify-center">
                            <svg className="w-full h-full" viewBox="0 0 98 85" fill="none"
                                 xmlns="http://www.w3.org/2000/svg">
                                <rect y="28.3333" width="56.6667" height="56.6667" fill="#FF6A00"/>
                                <rect x="72.5333" y="44.2" width="24.9333" height="24.9333" fill="#8640FF"/>
                                <rect x="28.3334" width="56.6667" height="56.6667" fill="#FF8F40"/>
                                <rect x="28.3334" y="28.3333" width="28.3333" height="28.3333" fill="#FFCEAC"
                                      fillOpacity="0.51"/>
                                <rect x="72.5333" y="44.2" width="12.4667" height="12.4667" fill="#8640FF"
                                      fillOpacity="0.37"/>
                            </svg>
                        </div>
                    </div>
                ...
                {step === 1 && (
                    <>
                        ...
                        <div className="flex flex-col gap-4">
                            ...
                            >
                                <div>
                                    <h3 className="uppercase font-black text-xl md:text-2xl leading-none">Je cherche un
                                        artisan</h3>
                            ...
                            >
                                <div>
                                    <h3 className="uppercase font-black text-xl md:text-2xl leading-none">Je suis
                                        artisan</h3>
                                    <p className="text-sm font-medium opacity-80 mt-1">Pro · Commission 4%</p>
                                </div>
                            </div>
                        </div>
                    </>
                ...
                <div className="w-full flex items-center justify-center">
                    <form onSubmit={handleSubmit} className="flex flex-col justify-center gap-6 md:w-96 w-80">
                        {step === 2 && (
                            <>
                                ...
                                <div>
                                    ...
                                    <div className="validator-hint hidden text-xs text-gray-400">Entrer une adresse
                                        email valide
                                    </div>
                                </div>
                                ...
                                <div>
                                    <fieldset className="fieldset">
                                        ...
                                        <p className="label text-xs text-gray-400 mt-1">Optionnel</p>
                                    </fieldset>
                                </div>
                                        ...
                                        <div>
                                            <label className="input validator w-full h-12">
                                                <input
                                                    ...
                                                    onChange={(e) => setFormData({
                                                        ...formData,
                                                        metiers: e.target.value.split(",").map((m) => m.trim()),
                                                    })}
                                                    required
                                                />
                                            </label>
