...
export default function Register() {
  ...
  const inputStyleWithIcon =
    "w-full bg-gray-50 dark:bg-neutral-900 border border-gray-200 dark:border-neutral-800 h-14 pl-14 pr-5 rounded-2xl focus:ring-2 focus:ring-black dark:focus:ring-white transition-all outline-none text-black dark:text-white";
  const inputStyle =
    "w-full bg-gray-50 dark:bg-neutral-900 border border-gray-200 dark:border-neutral-800 h-14 px-5 rounded-2xl focus:ring-2 focus:ring-black dark:focus:ring-white transition-all outline-none text-black dark:text-white";
    ...
    <div className="fixed inset-0 bg-white dark:bg-neutral-950 flex flex-col px-7 pb-8 pt-12 overflow-y-auto transition-colors duration-300">
          ...
          <div className="space-y-4 animate-in fade-in slide-in-from-right-4 duration-300">
            {userType === "professionnel" && (
              <>
                ...
                <div className="space-y-2">
                  <p className="text-xs font-bold uppercase text-gray-400 ml-1">
            ...
            <div className="flex gap-3 mt-4">
              <button
                type="button"
                onClick={prevStep}
                className="flex-1 bg-gray-100 dark:bg-neutral-900 text-black dark:text-white py-5 rounded-2xl font-black uppercase"
              >
                Retour
              </button>
              <button
              ...
              >
                S'inscrire{" "}
                <IonIcon name="checkmark-circle-outline" className="text-xl" />
              </button>
            </div>
          </div>
        )}
      ...
      <div className="mt-auto pt-6 text-center">
        <p className="text-gray-400 text-sm">
          ...
          <Link
            to="/login"
            className="text-black dark:text-white font-black uppercase"
          >
            Connexion
          </Link>
        </p>
