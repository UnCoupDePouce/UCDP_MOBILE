      ...
      <main className="px-6 pt-8 pb-32">
        ...
        <section className="bg-black dark:bg-white p-8 rounded-[40px] mb-12 shadow-2xl shadow-black/20 dark:shadow-white/5 relative overflow-hidden">
          <div className="relative z-10">
            <p className="text-[10px] font-black uppercase tracking-[0.2em] text-white/50 dark:text-black/40 mb-2">
              Ton Solde Actuel
            </p>
            ...
            {CREDIT_PACKS.map((pack) => (
              ...
              >
                ...
                <div className="flex items-center gap-5 w-full">
                  ...
                  <div
                    className={`size-16 shrink-0 ${pack.color} rounded-[22px] flex items-center justify-center text-white shadow-lg`}
                  >
        ...
        <div className="mt-12 p-6 bg-gray-50 dark:bg-neutral-900 rounded-[32px] border border-dashed border-gray-200 dark:border-white/10">
          <div className="flex gap-4 items-start">
            <IonIcon
              ...
              className="text-2xl text-black dark:text-white shrink-0"
            />
            <div>
              <h4 className="text-[10px] font-black uppercase text-black dark:text-white mb-1">
                Paiement Sécurisé
              </h4>
              <p className="text-[10px] font-medium text-gray-400 dark:text-neutral-500 leading-relaxed">
                Vos transactions sont protégées. Les crédits sont ajoutés
